...
import (
	...
	config "github.com/netcracker/qubership-core-control-plane/configuration"
	...
	"github.com/netcracker/qubership-core-control-plane/restcontrollers/health"
	...
	compositeV3 "github.com/netcracker/qubership-core-control-plane/restcontrollers/v3/composite"
	"github.com/netcracker/qubership-core-control-plane/services/active"
	"github.com/netcracker/qubership-core-control-plane/services/bluegreen"
	"github.com/netcracker/qubership-core-control-plane/services/cleanup"
	...
	drSrv "github.com/netcracker/qubership-core-control-plane/services/dr"
	...
	health2 "github.com/netcracker/qubership-core-control-plane/services/health"
	...
	srv1 "github.com/netcracker/qubership-core-control-plane/services/route/v1"
	srv2 "github.com/netcracker/qubership-core-control-plane/services/route/v2"
	srv3 "github.com/netcracker/qubership-core-control-plane/services/route/v3"
	"github.com/netcracker/qubership-core-control-plane/services/routingmode"
	"github.com/netcracker/qubership-core-control-plane/services/statefulsession"
	tlsDef "github.com/netcracker/qubership-core-control-plane/services/tls"
	"github.com/netcracker/qubership-core-control-plane/services/tm"
	...
	// swagger docs
	"github.com/netcracker/qubership-core-control-plane/docs"
	"net/http"
	"runtime"
	"strconv"
	"strings"
